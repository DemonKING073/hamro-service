...
const { Option } = Select;
const CreateVendorForms:FC<CustomDrawerProps> = ({onFinish, visible, onClose}) => {
    ...
    return(
        ...
        >
            <Form form={form} initialValues={{regionId: currentRegion?.id}} layout='vertical' onFinish={onFinish}>
                <Form.Item
                    name='name'
                    label='Vendor Name'
                    rules={[
...
export default CreateVendorForms